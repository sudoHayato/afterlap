...
- **Mudança face à sugestão do Grok**: em vez de Dart/Flutter, a app nativa é React Native via Expo, para reutilizar o motor TypeScript tal como está. Ver [adr/0002-react-native-expo.md](adr/0002-react-native-expo.md). Android primeiro, por decisão do CTO: [adr/0003-android-first.md](adr/0003-android-first.md).
