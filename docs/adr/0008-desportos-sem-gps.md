...
9. **Ecrã de gravação num segmento sem GPS**: o cronómetro do segmento e o total, o nome do desporto, e a lista de segmentos. Nada de distância, ritmo ou linha de coordenadas. O resumo lista cada segmento com o seu tempo; a distância total aparece só quando a sessão tem pelo menos um segmento com GPS.
