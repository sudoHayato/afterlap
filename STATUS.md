...
- **A cadência de 1 Hz não está provada.** A app pede 1 s e o sistema aceita, mas com o telemóvel imóvel dentro de casa entregou um fix a cada 4–6 s (81 buracos > 5 s em 9:25 de gravação). Há indícios de que é supressão de fixes repetidos pela pilha da Samsung, que a caminhada resolveria; é a primeira coisa que o teste de campo responde (relatório da sessão 04 §4.5 e §5).
...
**Teste de campo do fundador** — caminhada de 30 min com o build de release instalado, ecrã ligado, fechar/reabrir a meio; depois puxar a base e o registo bruto e correr `scripts/geojson.mjs`. **Começar pela verificação aos 2–3 min**: se o contador de amostras não subir perto de uma por segundo a caminhar, parar ali e falar com o CTO — é a cadência que está em dúvida, não vale gastar os 30 min. Procedimento e tabela em [docs/reports/2026-09-10-sessao-04.md](docs/reports/2026-09-10-sessao-04.md) §6. Se passar, a Fase 2 fecha e segue-se a **Fase 3** (segundo plano e fiabilidade) — ver [ROADMAP.md](ROADMAP.md) e o BACKLOG.
