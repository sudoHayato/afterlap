...
**Data**: 2026-09-11 · **Branch**: `main` · **Fase**: 1 e 2 concluídas (2026-09-10); **Fase 3 em curso — parte 1 (desportos sem GPS, sessão 05) e parte 2 (ritmo, precisão na base, exportação, sessão 06) concluídas; parte 3 (segundo plano) por iniciar**
...
- O teste de dispositivo falhou uma vez por margem (5 s depois de "Continuar" sem amostra nova, logo após um Metro `--clear`) e passou 6/6 à segunda sem alterações — relatório da sessão 06 §4.2. Decisão do CTO: se voltar a falhar, alargar para 10 s e registar os tempos reais.
