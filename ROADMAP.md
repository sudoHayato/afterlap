...
- **Estado**: código e documentação da sessão 01 (2026-09-09) em `main`. Sessão 02 (mesma data): i18n, correções aprovadas pelo CTO, ambiente em Node 24, `eas.json` pronto — primeiro APK via EAS Build **bloqueado no login** (precisa do CTO). Ver `docs/reports/2026-09-09-sessao-01.md` e `docs/reports/2026-09-09-sessao-02.md`.
