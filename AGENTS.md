...
- **O CTO** — o Codex do chat: revê o trabalho, levanta as dúvidas e escreve os briefs de cada sessão.
- **Tu (Codex)** — a equipa de desenvolvimento: executas o brief e reportas.
...
- Commits pequenos, no imperativo, com corpo a explicar o porquê, terminados em `Co-Authored-By: Codex Fable 5.1 <noreply@anthropic.com>`. Branches: `chore/`, `feat/`, `fix/`, `docs/`.
